  ...
  export default {
    ...
    methods: {
      ...
      savedata() {//- 添加数据
        ...
        if(that.editState){
          that.datalist.list=that.datalist.list.map((item)=>{
      ...
      closeFloat() {//- 关闭一些弹框的跨子组件方法
        ...
        // that.modelToggle = false;
        document.getElementById('model_save_show').style.display = 'none';
      },
...
<style lang="sass">
  @import "../../css/components/datalist"
</style>
